...
public class AdminDAOImplimentation implements AdminDAO{
	...
	public int addAdminProfile(AdminEntity adminEntity) {
		String sql="insert into admin(admin_name,admin_mobile,admin_email,admin_password)values('"+adminEntity.getAdmin_name()+"','"+adminEntity.getAdmin_mobile()+"','"+adminEntity.getAdmin_email()+"','"+adminEntity.getAdmin_password()+"')";    
		return template.update(sql);
	}

	@Override
	public int editAdminProfile(AdminEntity adminEntity) {
		String sql="update admin set admin_name='"+adminEntity.getAdmin_name()+"',admin_mobile='"+adminEntity.getAdmin_mobile()+"',admin_email='"+adminEntity.getAdmin_email()+"',admin_password='"+adminEntity.getAdmin_password()+"' where admin_id="+adminEntity.getAdmin_id()+" ";
		return template.update(sql);
	}
	
	@Override
	public List<Login> adminLogin(Login login) {
		String sql="select * from admin where admin_email='"+login.getAdmin_email()+"' and admin_password='"+login.getAdmin_password()+"' ";
	...
	public List<AdminEntity> getByEmail(String emailId) {
		String sql="select * from admin where admin_email='"+emailId+"' ";
	...
	public List<ForgotByEmail> checkEmailExist(ForgotByEmail byEmail) {
		...
		String sql="select * from admin where admin_email='"+byEmail.getAdmin_email()+"' ";
	...
	public int updatePassword(ForgotPassword forgotPassword) {
		String sql="update admin set admin_password='"+forgotPassword.getAdmin_password()+"' where admin_email='"+forgotPassword.getAdmin_email()+"' ";
		return template.update(sql);
	}
}
